export default function CourseCard({ img, titulo, autor, descripcion }) {
  return (
    <div className="bg-[#19191F] rounded-xl shadow-md w-[300px] p-5 text-left text-white hover:shadow-xl hover:brightness-105 transition-all">
      ...
      <button className="bg-blue-600 hover:bg-blue-700 px-4 py-2 text-sm rounded-md font-semibold transition-all">
        Aprende más
      </button>
    </div>
  );
