      ...
      <main className="flex flex-col md:flex-row flex-grow pt-[55px]">
        ...
        <div className="md:w-[40%] w-full flex justify-end pr-4 items-center relative z-10">
          <div className="bg-[#19191F] rounded-lg p-8 shadow-2xl w-full max-w-md my-8 animate-fade-in-up">
            ...
            <button className="w-full py-2 bg-gradient-to-r from-[#799EB8] to-[#678a9d] text-white rounded-md mb-4 text-sm font-semibold hover:scale-105 hover:brightness-110 transition-all duration-500 relative overflow-hidden">
            ...
            {[
              { img: "youtube.png", label: "Youtube" },
              { img: "apple.png", label: "Apple" },
              { img: "facebook.png", label: "Facebook" }
            ].map(({ img, label }) => (
              <button
                key={label}
