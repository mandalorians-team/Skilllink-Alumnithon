...
const mentores = [
  ...
  { id: 2, nombre: "Alejandra Toloza", especialidad: "Arquitectura de Software" },
  ...
  { id: 11, nombre: "Camilo Herrera", especialidad: "Base de Datos (SQL/NoSQL)" },
  ...
  { id: 24, nombre: "Monica Parra", especialidad: "Pentesting y Hacking Ético" },
  ...
  { id: 29, nombre: "Julieta Méndez", especialidad: "Mentoría en Carreras Tech" },
  { id: 30, nombre: "Laura Fonseca", especialidad: "Automatización con Python" },
];
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-10">
            {mentores.map((mentor) => (
              ...
              >
                ...
                <button className="bg-[#799EB8] hover:bg-[#5e7e91] text-white py-2 px-6 rounded-full font-semibold transition duration-200 shadow-md">
                  Invocar Mentor
                </button>
              </div>
            ))}
