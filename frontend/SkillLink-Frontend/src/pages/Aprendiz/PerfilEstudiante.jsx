import ModalEditarPerfil from "../../components/ui/ModalEditarPerfil";
...
export default function PerfilEstudiante() {
  ...
  if (!user) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-[#B8CFDF]">
        <span className="text-gray-600 text-lg">
          No hay datos de usuario. Inicia sesión.
        </span>
      </div>
    );
  }
        ...
        <main className="flex-1 p-4 space-y-4">
          ...
          <section className="bg-[#19191F] rounded p-4 relative">
            ...
            <div className="flex items-center space-x-4">
              <img
                src={user.imagen || "/images/Mentor 3.jpg"}
                alt="Avatar"
